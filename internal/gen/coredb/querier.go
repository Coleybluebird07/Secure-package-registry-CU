...
type Querier interface {
	...
	GetRebuildTask(ctx context.Context, id int32) (RebuildTask, error)
	// Finds a rebuild task for a given ecosystem, package identifier, version, and source.
	GetRebuildTaskForPackageVersion(ctx context.Context, arg GetRebuildTaskForPackageVersionParams) (RebuildTask, error)
	...
	HasActiveRebuildTask(ctx context.Context, arg HasActiveRebuildTaskParams) (bool, error)
	...
	InsertRebuildTask(ctx context.Context, arg InsertRebuildTaskParams) (InsertRebuildTaskRow, error)
	...
	ListRebuildTasks(ctx context.Context, arg ListRebuildTasksParams) ([]ListRebuildTasksRow, error)
	...
	ResetRebuildTask(ctx context.Context, id int32) error
	...
	UpdateRebuildTaskFailed(ctx context.Context, arg UpdateRebuildTaskFailedParams) error
	UpdateRebuildTaskHeartbeat(ctx context.Context, id int32) error
	UpdateRebuildTaskRunning(ctx context.Context, id int32) error
	UpdateRebuildTaskStatus(ctx context.Context, arg UpdateRebuildTaskStatusParams) error
	UpdateRebuildTaskSucceeded(ctx context.Context, arg UpdateRebuildTaskSucceededParams) error
	UpdateRebuildTaskUnavailable(ctx context.Context, arg UpdateRebuildTaskUnavailableParams) error
}
